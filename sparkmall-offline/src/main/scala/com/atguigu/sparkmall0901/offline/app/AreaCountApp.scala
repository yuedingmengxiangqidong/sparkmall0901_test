...
import com.atguigu.sparkmall0901.offline.udf.CityRationUDAF
...
object AreaCountApp {
  ...
  def main(args: Array[String]): Unit = {
    ...
    sparkSession.udf.register("city_ratio", new CityRationUDAF)
