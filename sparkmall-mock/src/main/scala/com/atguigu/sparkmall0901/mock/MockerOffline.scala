package com.atguigu.sparkmall0901.mock

import java.text.SimpleDateFormat
import java.util.UUID

import com.atguigu.sparkmall0901.common.bean.{CityInfo, ProductInfo, UserInfo, UserVisitAction}
import com.atguigu.sparkmall0901.mock.util.RandomOptions.RanOpt
import com.atguigu.sparkmall0901.mock.util.{RandomDate, RandomNum, RandomOptions}
...
object MockerOffline {
  ...
  def mockUserAction() = {
    ...
    val startDate = new SimpleDateFormat("yyyy-MM-dd").parse("2019-02-16")
    val endDate = new SimpleDateFormat("yyyy-MM-dd").parse("2019-02-17")
